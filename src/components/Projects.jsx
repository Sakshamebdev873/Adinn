      ...
      <div className="mt-12 w-full h-full">
        <div className="grid grid-cols-2 w-full px-40">
          ...
          <div className="flex flex-col  w-full  ">
            ...
            <div className="flex  text-[64px] w-full leading-[105px] text-left gap-x-1.5 ">
...
const {image,image2,title,text} = item
 return <div key={index} className={index%2 == 0 ? `flex mt-20 w-full gap-x-20 justify-center items-center`: `flex mt-20 w-full gap-x-20 flex-row-reverse justify-center items-center`}>
 {/* part-1 */}
 <div className={index===3?'flex flex-col pl-[20rem] relative':'flex flex-col relative'}>
 ...
 <div className="pr-52 pb-24 ">
   {image2.length === 0? null : <img src={image2} alt="" className="h-[300px] w-[300px]" /> }
 </div>
</div>

      })}
        <div className="flex justify-center items-center text-[16px] text-[#AEAEAE] mt-24 leading-[24px]" >
<button type="button" className="border border-[#AEAEAE] px-[20px] cursor-pointer rounded-[21px] py-[9px]" >View More</button>
        </div>
        ...
        <div className="w-[1220px] h-[462px] bg-[#EC2B45] flex gap-y-4 rounded-2xl px-24  justify-center mt-24 items-center" >
          ...
          <div className="flex flex-col  justify-center items-center " >
            <img src="/img8.png" alt="" className="h-[204px] mb-12 w-[182px]" />
            <div className="flex flex-col text-[17px] leading-[27px] -mt-12 text-[#eaacbf]" >
<p>Our team is here to help you succeed.
Let's work together to achieve your goals and elevate your brand to new heights.</p>
            </div>
            <button type="button" className="cursor-pointer px-[24px] py-[16px] mt-4 bg-white font-semibold rounded-[26px] text-[17px] leading-[21px] " >Book a call</button>
          </div>
        </div>
        </div>
      </div>
